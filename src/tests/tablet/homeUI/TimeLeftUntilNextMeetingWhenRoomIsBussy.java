...
public class TimeLeftUntilNextMeetingWhenRoomIsBussy {
	...
	public void end() {
		...
		try {
			RootRestMethods.deleteMeeting(room, subjectNextMeeting, authenticationNextMeeting);
			log.info("The meeting:" + subjectNextMeeting + "has been deleted successfully.");	

			RootRestMethods.deleteMeeting(room, subjectCurrentMeeting, authenticationCurrentMeeting);
