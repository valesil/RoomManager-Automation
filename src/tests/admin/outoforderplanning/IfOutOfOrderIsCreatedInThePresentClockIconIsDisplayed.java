...
/**
 * TC14: Verify that Clock icon appears in out of order column when the schedule 
 * to be out of order is current time
 * @author Yesica Acha
 *
 */
public class IfOutOfOrderIsCreatedInThePresentClockIconIsDisplayed {
	...
	String roomName = testData.get(3).get("Room Name").replaceAll(" ", "");
