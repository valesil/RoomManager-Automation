...
import static main.java.utils.MessageConstants.OUT_OF_ORDER_IN_THE_PAST;
import static main.java.utils.MessageConstants.OUT_OF_ORDER_SHOULD_HAVE_A_TITLE;
import static main.java.utils.MessageConstants.TO_GRATER_THAN_FROM;
 ...
 *
 */
public class RoomOutOfOrderPage extends RoomBaseAbstractPage {
	 ...
	 */
	public RoomOutOfOrderPage setTitleTxtBox (String title) {
		titleTxtBox.clear();
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage setDescriptionTxtBox (String description) {
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage selectEmailNotificationChkBox() {
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	private RoomOutOfOrderPage clickActivationBtn() {
		activationBtn.click();
		return this;
	}
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage setStartDateWithCalendar(String date) {
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage setEndDateWithCalendar(String date) {
	...
	private void setDateWithCalendar(String modifierValue, String dateSelector) {
		...
		String date = TimeMethods.getDate(Integer.parseInt(modifierValue), "MMM dd YYYY");

		//to click date's year button
		clickCalendarElementBtn(TimeMethods.getDateElement(date, "year"), dateSelector);

		//to click date's month button
		clickCalendarElementBtn(TimeMethods.getDateElement(date, "month"), dateSelector);

		//to click date's day button
		clickCalendarElementBtn(TimeMethods.getDateElement(date, "day"), dateSelector);
	}
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage setStartTime (String startTime) {
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage setEndTime (String endTime) {
		setTime(endTime, "to");
		return this;
	}
	...
	private void setTime (String modifierValue, String timeSelector) {
		...
		String time = TimeMethods.getTime(minutesToAdd, "hh:mm a");
		String hours = TimeMethods.getTimeElement(time,"hours");
		String minutes = TimeMethods.getTimeElement(time, "minutes");
		String meridian = TimeMethods.getTimeElement(time,"meridian");
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage clickStartTimeIncrementHoursBtn() {
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage clickStartTimeDecrementHoursBtn() {
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage clickStartTimeIncrementMinutesBtn() {
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage clickStartTimeDecrementMinutesBtn() {
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage clickEndTimeIncrementHoursBtn() {
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage clickEndTimeDecrementHoursBtn() {
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage clickEndTimeIncrementMinutesBtn() {
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage clickEndTimeDecrementMinutesBtn() {
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	private RoomOutOfOrderPage clickArrowBtn(String timeSelector, String action) {
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage setOutOfOrderPeriodInformation(String startDate, String endDate, 
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage activateOutOfOrder(){
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage deactivateOutOfOrder(){
		if(isOutOfOrderActivated()) {
			clickActivationBtn();
		}
		return this;
	...
	public String getDefaultStartTimeValue() {
		String currentTime = TimeMethods.getCurrentDate("hh:mm a");
		return TimeMethods.getNextHalfHourPeriod(currentTime);
	}
	...
	public String getDefaultEndTimeValue() {
		return TimeMethods.getNextHalfHourPeriod(getDefaultStartTimeValue());
	}
	 ...
	 * @return RoomOutOfOrderPlanningPage
	 */
	public RoomOutOfOrderPage clickSaveWithErrorBtn() {
		saveBtn.click();
