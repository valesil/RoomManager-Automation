...
public class RoomDoesNotAllowsBlankTextForDisplayName {
	...
	public void testRoomAllowsBlankTextForCapacity() throws InterruptedException, BiffException, IOException {
		...
		infoPage.setDisplayName("").clickSaveBtn();

		//Verify if error message is displayed when empty value is inserted
		Assert.assertEquals(infoPage.getErrorMessageDisplayName(), ROOM_DISPLAY_NAME_EMPTY);		
	}
